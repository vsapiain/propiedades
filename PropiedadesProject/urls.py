...
urlpatterns = [
    ...
    url(r'^propiedades/publicaciones/(?P<id>\w+)/$', views.publicacion_resumen, name='publicacion_resumen'),
    url(r'^propiedades/resumen/', views.publicacion_resumen, name='visualizar_publicacion'),
    url(r'^planes/info/', views.planes, name='planes'),
    url(r'^usuarios/configuraciones/$', views.editar_usuario, name='editar_usuario'),
    url(r'^usuarios/cuentas/configuraciones/$', views.editar_cuenta, name='editar_cuenta'),
    url(r'^usuarios/planes', views.editar_planes, name='editar_planes'),
    url(r'^usuarios/comerciales/editar', views.editar_datos_comercial, name='editar_comercial'),
    url(r'^propiedades/datos/$', views.panel, name='panel'),
