...
class DetallePlanContrato(models.Model):
    ...
    sdetalle_detalle_plan_contrato = models.CharField(db_column='SDetalle__detalle_plan_contrato', max_length=500, blank=True, null=True)  # Field name made lowercase. Field renamed because it contained more than one '_' in a row.
